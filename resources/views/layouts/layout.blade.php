...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="{{route('lend.index')}}">Reservas</a>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Libreria 2024</div>
                            <div>
        ...
        <script src="{{asset('js/dataTables.bootstrap5.js')}}" crossorigin="anonymous"></script>
        <script src="{{asset('js/sweetalert2@11.js')}}" crossorigin="anonymous"></script>
        @yield('script')
